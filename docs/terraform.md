...
| <a name="input_metadata_tags_enabled"></a> [metadata\_tags\_enabled](#input\_metadata\_tags\_enabled) | Whether tags are available in the metadata service is available | `bool` | `true` | no |
