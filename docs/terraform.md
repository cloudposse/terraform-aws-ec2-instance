...
| <a name="input_permissions_policies_arns"></a> [permissions\_policies\_arns](#input\_permissions\_policies\_arns) | Policies ARNs to attach to instance role as a permissions policy | `list(string)` | `[]` | no |
